...
print('\nWelcome to our user-friendly Temperature Converter!')
...
print("\033[34mWhich type of conversion are you looking to perform?")
...
#conversion_value = (number_to_convert * 9/5) + 32 if conversion_type == 'c' else (number_to_convert -32) * 5/9
